<%@ Page Title="" Language="C#" MasterPageFile="~/site-customer.master" AutoEventWireup="true" CodeFile="customer-instruction.aspx.cs" Inherits="customer_catalogue" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphSite" Runat="Server">
    <a href="#">Customer Support<span class="icon-caret-right"></span></a><span>Instruction Manual</span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <h1 class="title desktop-992">Instruction Manual</h1>
   <h2 class="title-menu mobile-992"><a class="panel-right" href="#mobileRight">Instruction Manual<span class="iconar icon-chevron-down"></span></a></h2>
   ...
   <h2 class="title-link mobile-992"><a class="panel-right" href="#mobileRight"><span class="icon-chevron-left"></span>Instruction Manual</a></h2>
</asp:Content>
