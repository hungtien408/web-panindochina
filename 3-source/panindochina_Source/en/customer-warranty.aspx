...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Warranty / Technical & Service Request</title>
    <meta name="description" content="Warranty / Technical & Service Request" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphSite" runat="Server">
    <a href="customer-catalogue.aspx">Customer Support<span class="icon-caret-right"></span></a><span>Warranty
        / Technical &amp; Service Request</span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h1 class="title desktop-992">
        Warranty / Technical &amp; Service Request</h1>
    <h2 class="title-menu mobile-992">
        <a class="panel-right" href="#mobileRight">Warranty / Technical &amp; Service Request<span
    ...
    <h2 class="title-link mobile-992">
        <a class="panel-right" href="#mobileRight"><span class="icon-chevron-left"></span>Warranty
            / Technical &amp; Service Request</a></h2>
</asp:Content>
