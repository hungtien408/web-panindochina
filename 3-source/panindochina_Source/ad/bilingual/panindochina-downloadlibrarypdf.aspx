<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="panindochina-downloadlibrarypdf.aspx.cs" Inherits="ad_single_download" %>
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 168px x 217px)</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left" valign="top">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="DownloadDelete"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchDownloadName" Name="DownloadName" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="ddlSearchCategory" DefaultValue="1" Name="DownloadCategoryID" PropertyName="SelectedValue"
                Type="String" />
            <asp:Parameter Name="IsAvailable" Type="String" />
            <asp:Parameter Name="Priority" Type="String" />
