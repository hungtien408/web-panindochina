<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/inside.master" AutoEventWireup="true"
    CodeFile="productvideo.aspx.cs" Inherits="ad_single_video" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <br />
    <asp:RadProgressManager ID="RadProgressManager2" runat="server" />
    <asp:RadProgressArea ID="RadProgressArea1" runat="server" Culture="vi-VN" DisplayCancelButton="True"
                        ...
                        <ItemTemplate>
                            <div style="width: 60px">
                                <span runat="server" visible='<%# Eval("ImagePath").ToString() == "" ? false : true %>'>
                                    <a class="screenshot" rel='../../res/product/video/thumbs/<%# Eval("ImagePath") %>'>
                                        <img alt="" title="View Image" src="../assets/images/photo.png" runat="server" visible='<%# Eval("ImagePath").ToString() == "" ? false : true %>' />
                                    </a>
                                    <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("ProductVideoID") + "#" + Eval("ImagePath") %>'
                                ...
                                <img alt="" title="Xem Video" src="../assets/images/play.png" style="cursor: pointer"
                                    onclick="openWindow('viewvideo.aspx?VI=<%# Eval("ProductVideoID") %>','Xem Video')" />
                            </div>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                </Columns>
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">
                                Thông Tin Video</h3>
                            <asp:HiddenField ID="hdnProductVideoID" runat="server" Value='<%# Eval("ProductVideoID") %>' />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductVideoSelectAll"
        TypeName="TLLib.ProductVideo" DeleteMethod="ProductVideoDelete" InsertMethod="ProductVideoInsert"
        UpdateMethod="ProductVideoUpdate">
        <DeleteParameters>
            <asp:Parameter Name="ProductVideoID" Type="String" />
        </DeleteParameters>
        <InsertParameters>
