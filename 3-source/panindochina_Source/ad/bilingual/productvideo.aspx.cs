...
public partial class ad_single_video : System.Web.UI.Page
{
    ...
    void DeleteImage(string strImageName)
    {
        ...
        {
            var strImagePath = Server.MapPath("~/res/product/video/thumbs/" + strImageName);
    ...
    void DeleteVideo(string strVideoName)
    {
        ...
        {
            var strVideoPath = Server.MapPath("~/res/product/video/" + strVideoName);
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "DeleteSelected")
        {
            ...
            {
                VideoID = item.GetDataKeyValue("ProductVideoID").ToString();
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            var strProductVideoID = ((HiddenField)row.FindControl("hdnProductVideoID")).Value;
            ...
            var oProductVideo = new ProductVideo();
            strProductVideoID = !string.IsNullOrEmpty(strProductVideoID) ? strProductVideoID : oProductVideo.ProductVideoSelectMaxID();
            strImagePath = string.IsNullOrEmpty(strImagePath) ? "" : (string.IsNullOrEmpty(strConvertedTitle) ? "" : strConvertedTitle + "-") + strProductVideoID + strImagePath.Substring(strImagePath.LastIndexOf('.'));
            strVideoPath = string.IsNullOrEmpty(strVideoPath) ? "" : (string.IsNullOrEmpty(strConvertedTitle) ? "" : strConvertedTitle + "-") + strProductVideoID + strVideoPath.Substring(strVideoPath.LastIndexOf('.'));
            ...
            else
            {
                ...
                if (FileImagePath.UploadedFiles.Count > 0)
                {
                    strOldImagePath = Server.MapPath("~/res/product/video/thumbs/" + strOldImagePath);
                ...
                if (FileVideoPath.UploadedFiles.Count > 0)
                {
                    strOldVideoPath = Server.MapPath("~/res/product/video/" + strOldVideoPath);
    ...
    protected void RadGrid1_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridEditableItem && e.Item.IsInEditMode)
        {
            ...
            var ProductVideoID = ((HiddenField)row.FindControl("hdnProductVideoID")).Value;

            if (!string.IsNullOrEmpty(ProductVideoID))
            {
                dv.RowFilter = "ProductVideoID = " + ProductVideoID;
            }
