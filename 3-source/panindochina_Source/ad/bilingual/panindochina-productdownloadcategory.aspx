<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="panindochina-productdownloadcategory.aspx.cs" Inherits="ad_single_productdownload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderText="File Download" HeaderStyle-Width="1%" Visible="false">
                        <ItemTemplate>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductDownloadCategorySelectAll1"
            TypeName="TLLib.ProductDownloadCategory" DeleteMethod="ProductDownloadCategoryDelete"
            InsertMethod="ProductDownloadCategoryInsert" 
