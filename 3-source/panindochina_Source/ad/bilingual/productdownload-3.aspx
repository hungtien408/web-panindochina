<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/inside.master" AutoEventWireup="true"
    CodeFile="productdownload-3.aspx.cs" Inherits="ad_single_photoalbum" %>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" 
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderText="Tên Album" DataField="ProductDownloadName"
                        SortExpression="ProductDownloadName">
                        <ItemTemplate>
                            <asp:Label ID="lblProductDownloadName" runat="server" Text='<%# Eval("ProductDownloadCategoryName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Tên Album(Tiếng Anh)" DataField="ProductDownloadCategoryNameEn"
                        SortExpression="ProductDownloadCategoryNameEn">
                        <ItemTemplate>
                            <asp:Label ID="lblProductDownloadCategoryNameEn" runat="server" Text='<%# Eval("ProductDownloadCategoryNameEn")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                                        ...
                                        <div class="sub_box">
                                            ...
                                            <div class="cont">
                                                <asp:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                                    <asp:RadAsyncUpload ID="FileLinkDownload" runat="server" MultipleFileSelection="Automatic"
                                                        TargetFolder="~/res/product/download/" TemporaryFolder="~/res/TempAsync" Width="100%"
                                                        Localization-Select="Chọn" Localization-Cancel="Hủy"
                                                    ...
                                                    <asp:RadAjaxPanel ID="RadAjaxPanel3" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                                        <asp:RadListView runat="server" ID="RadListView1" DataSourceID="OdsProductDownload" DataKeyNames="ProductDownloadID"
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <fieldset style="float: left; margin: 5px; padding: 2px 2px 2px 2px; position: relative;
                                                                    ...
                                                                    <a href='<%# "~/res/product/download/" + Eval("LinkDownload") %>' runat="server" class="lightbox">
                                                                        <%# Eval("LinkDownload") %>
                                                                    </a>
                                                                    <div align="right">
                                                                            ...
                                                                            <td valign="top" style="padding-right: 10px">
                                                                                <table class="search" width="100%">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <asp:RadTextBox ID="txtFileName" Width="100%" runat="server" Text='<%# Bind("FileName") %>'
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <asp:RadTextBox ID="txtFileNameEn" Width="100%" runat="server" Text='<%# Bind("FileNameEn") %>'
