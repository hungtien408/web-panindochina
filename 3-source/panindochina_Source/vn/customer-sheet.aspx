...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Thông Số Kĩ Thuật</title>
    <meta name="description" content="Technical Sheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphSite" runat="Server">
    <a href="customer-catalogue.aspx">Hỗ Trợ Khách Hàng<span class="icon-caret-right"></span></a><span>Thông Số Kĩ Thuật</span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h1 class="title desktop-992">
        Thông Số Kĩ Thuật</h1>
    <h2 class="title-menu mobile-992">
        <a class="panel-right" href="#mobileRight">Thông Số Kĩ Thuật<span class="iconar icon-chevron-down"></span></a></h2>
    ...
    <h2 class="title-link mobile-992">
        <a class="panel-right" href="#mobileRight"><span class="icon-chevron-left"></span>Thông Số Kĩ Thuật</a></h2>
</asp:Content>
