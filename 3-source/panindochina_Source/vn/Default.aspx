    ...
    <div class="container">
        ...
        <div class="wrapper-tabs">
            <div class="head desktop-showhide">
                ...
                <a href="product.aspx" class="more-all">Xem tất cả <span class="icon-caret-right"></span>
                </a>
            </div>
                ...
                <ItemTemplate>
                    <div class="colno-3 element-item">
                        <div class="servece-box wrap-effecth">
                            <a href='<%# progressTitle(Eval("ServiceCategoryName")) + "-sci-" + Eval("ServiceCategoryID") + ".aspx" %>'
                                class="product-img effect-hover"><span class="hover-img fullbox-img">
                            ...
                            <h5 class="product-name">
                                <a href='<%# progressTitle(Eval("ServiceCategoryName")) + "-sci-" + Eval("ServiceCategoryID") + ".aspx" %>'
                                    ...
                                    <%# Eval("ServiceCategoryName")%><span class="icon-angle-right iconar"></span></a></h5>
                        </div>
                    </div>
                </ItemTemplate>
                <LayoutTemplate>
