...
<body>
    ...
    <asp:FormView ID="FormView2" runat="server" DataSourceID="ObjectDataSource1" EnableModelValidation="True"
                Width="100%">
                <ItemTemplate>
                    <iframe src='http://docs.google.com/viewer?url=<%# Request.Url.Scheme +"://"+ Request.Url.Host + "/res/download/"+ Eval("FilePath") %>&embedded=true'
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="DownloadSelectOne"
                ...
                <SelectParameters>
                    <asp:QueryStringParameter Name="DownloadID" QueryStringField="vd" Type="String" DefaultValue="-1" />
                </SelectParameters>
