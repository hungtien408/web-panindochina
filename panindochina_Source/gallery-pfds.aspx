<%@ Page Title="" Language="C#" MasterPageFile="~/site-gallery.master" AutoEventWireup="true"
    CodeFile="gallery-pfds.aspx.cs" Inherits="gallery_pfd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphSite" runat="Server">
    <a href="gallery.aspx">Library<span class="icon-caret-right"></span></a><a href="gallery-pfd.aspx">PDF<span class="icon-caret-right"></span></a><span><asp:Label
        ...
        <ContentTemplate>
            ...
            <asp:ObjectDataSource ID="odsPDF" runat="server" SelectMethod="DownloadSelectAll"
                ...
                <SelectParameters>
                    ...
                    <asp:QueryStringParameter QueryStringField="dri" Name="DownloadCategoryID" Type="String" />
