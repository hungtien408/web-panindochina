            ...
            <asp:ListView ID="lstDownloadCategory" runat="server" EnableModelValidation="True">
                <ItemTemplate>
                    ...
                    <asp:ListView ID="lstDownload" runat="server" DataSourceID="odsDownload" EnableModelValidation="True">
                        <ItemTemplate>
                            <li><%# !string.IsNullOrEmpty(Eval("FilePath").ToString()) ? "<a class='download-link corner' download href='" + "res/download/" + Eval("FilePath") + "'><span>Download</span></a>" : ""%> <%# Eval("DownloadNameEn")%></li>
                        </ItemTemplate>
                        <LayoutTemplate>
