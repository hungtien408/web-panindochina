<%@ Page Title="" Language="C#" MasterPageFile="~/en/site-customer.master" AutoEventWireup="true"
                ...
                <div class="col-lg-7">
                    <div class="form-btn">
                        <label class="form-lb">
                            End - User</label>
                        <div class="input-text">
                            <asp:DropDownList ID="listEndUser" runat="server" CssClass="selectb" DataSourceID="odsEndUser" DataTextField="ArticleTitle"
                ...
                <div class="col-lg-5">
                    <div class="input-in">
                        <label class="form-lb">
                            Trading</label>
                        <div class="input-text">
                            <asp:DropDownList ID="listTrading" runat="server" CssClass="selectb" DataSourceID="odsTrading" DataTextField="ArticleTitle"
                                DataValueField="ArticleID" ValidationGroup="RegisterForm">
                            </asp:DropDownList>
                ...
                <div class="col-lg-7">
                    <div class="form-btn">
                        <label class="form-lb">
                            Service</label>
                        <div class="input-text">
                            <asp:DropDownList ID="listService" runat="server" CssClass="selectb" DataSourceID="odsService" DataTextField="ArticleTitle"
                                DataValueField="ArticleID" ValidationGroup="RegisterForm">
                            </asp:DropDownList>
                ...
                <div class="col-lg-5">
                    <div class="input-in">
                        <label class="form-lb">
                            Trainer</label>
                        <div class="input-text">
                            <asp:DropDownList ID="listTrainer" runat="server" CssClass="selectb" DataSourceID="odsTrainer" DataTextField="ArticleTitle"
                                DataValueField="ArticleID" ValidationGroup="RegisterForm">
                            </asp:DropDownList>
                ...
                <div class="col-lg-7">
                    <div class="form-btn">
                        <label class="form-lb">
                            Safety Org</label>
                        <div class="input-text">
                            <asp:DropDownList ID="listSafetyOrg" runat="server" CssClass="selectb" DataSourceID="odsSafetyOrg" DataTextField="ArticleTitle"
                                DataValueField="ArticleID" ValidationGroup="RegisterForm">
                            </asp:DropDownList>
