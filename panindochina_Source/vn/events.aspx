...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:ObjectDataSource ID="odsEvents" runat="server" SelectMethod="ArticleSelectAll"
                ...
                <SelectParameters>
                    ...
                    <asp:Parameter DefaultValue="11" Name="ArticleCategoryID" Type="String" />
            ...
            <div id="pagerp" class="pager">
                <asp:DataPager ID="DataPager1" runat="server" PageSize="8" PagedControlID="lstEvents">
                    <Fields>
