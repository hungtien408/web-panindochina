<%@ Page Title="" Language="C#" MasterPageFile="~/vn/site-product.master" AutoEventWireup="true"
    CodeFile="product-sub-cat.aspx.cs" Inherits="product" %>
        ...
        <ContentTemplate>
            ...
            <asp:ObjectDataSource ID="odsProducts" runat="server" SelectMethod="ProductSelectAll"
                ...
                <SelectParameters>
                    ...
                    <asp:QueryStringParameter Name="CategoryID" QueryStringField="psci" Type="String" />
                    ...
                    <asp:Parameter DefaultValue="True" Name="SortByPriorityProductCat" Type="String" />
                </SelectParameters>
