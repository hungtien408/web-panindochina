<%@ Page Title="" Language="C#" MasterPageFile="~/vn/site-customer.master" AutoEventWireup="true" CodeFile="customer-quatation.aspx.cs" Inherits="customer_being" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Yêu Cầu Chào Giá</title>
    <meta name="description" content="Quotation Request" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphSite" Runat="Server">
    <a href="customer-catalogue.aspx">Hỗ Trợ Khách Hàng<span class="icon-caret-right"></span></a><span>Yêu Cầu Chào Giá</span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1 class="title desktop-992">Yêu Cầu Chào Giá</h1>
   <h2 class="title-menu mobile-992"><a class="panel-right" href="#mobileRight">Yêu Cầu Chào Giá<span class="iconar icon-chevron-down"></span></a></h2>
   ...
   <h2 class="title-link mobile-992"><a class="panel-right" href="#mobileRight"><span class="icon-chevron-left"></span>Yêu Cầu Chào Giá</a></h2>
</asp:Content>
