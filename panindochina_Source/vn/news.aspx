...
<asp:Content ID="Content2" ContentPlaceHolderID="cphSite" runat="Server">
    ...
    <asp:ListView ID="lstBreadcrum" runat="server" DataSourceID="odsBreadcrum" EnableModelValidation="True">
        <ItemTemplate>
            <%# string.IsNullOrEmpty(Request.QueryString["tri"]) ? "<span>News</span>" : Container.DataItemIndex == ((System.Data.DataView)odsBreadcrum.Select()).Count - 1 ? "<span>" + Eval("ArticleCategoryName") + "</span>" : !string.IsNullOrEmpty(Eval("ArticleCategoryLink").ToString()) ? Eval("ArticleCategoryLink") : "" %>
        </ItemTemplate>
        <LayoutTemplate>
