<%@ Page Title="" Language="C#" MasterPageFile="~/vn/site-gallery.master" AutoEventWireup="true" CodeFile="gallery-pfd.aspx.cs" Inherits="gallery_pfd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphSite" Runat="Server">
    <a href="gallery.aspx">Thư viện<span class="icon-caret-right"></span></a><span>PDF</span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:ListView ID="lstFaq" runat="server" DataSourceID="odsFaq" EnableModelValidation="True">
        <ItemTemplate>
            <li><a href='<%# progressTitle(Eval("DownloadCategoryName")) + "-dpi-" + Eval("ParentID") + "-dri-" + Eval("DownloadCategoryID") + ".aspx" %>'><%# Eval("DownloadCategoryName")%></a></li>
        </ItemTemplate>
        <LayoutTemplate>
            <ul class="list-faq">
