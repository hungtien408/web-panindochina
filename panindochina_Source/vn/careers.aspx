<%@ Page Title="" Language="C#" MasterPageFile="~/vn/site-about.master" AutoEventWireup="true"
    CodeFile="careers.aspx.cs" Inherits="events" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphSite" runat="Server">
    ...
    <asp:ListView ID="lstBreadcrum" runat="server" DataSourceID="odsBreadcrum" EnableModelValidation="True">
        <ItemTemplate>
            <%# string.IsNullOrEmpty(Request.QueryString["tri"]) ? "<span>Careers</span>" : Container.DataItemIndex == ((System.Data.DataView)odsBreadcrum.Select()).Count - 1 ? "<span>" + Eval("ArticleCategoryName") + "</span>" : !string.IsNullOrEmpty(Eval("ArticleCategoryLink").ToString()) ? Eval("ArticleCategoryLink") : "" %>
        </ItemTemplate>
        <LayoutTemplate>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:ListView ID="lstCareers" runat="server" DataSourceID="odsCareers" EnableModelValidation="True">
                <ItemTemplate>
            ...
            <asp:ObjectDataSource ID="odsCareers" runat="server" SelectMethod="ArticleSelectAll"
            ...
            <div id="pagerp" class="pager">
                <asp:DataPager ID="DataPager1" runat="server" PageSize="8" PagedControlID="lstCareers">
                    <Fields>
