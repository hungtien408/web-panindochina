...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
        ...
        AllowAutomaticUpdates="True" OnItemDataBound="RadGrid1_ItemDataBound" CellSpacing="0">
        ...
        <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
            ...
            <Columns>
                ...
                <asp:GridBoundColumn HeaderText="Danh mục" SortExpression="ProductDownloadCategoryName"
                    DataField="ProductDownloadCategoryName" Visible="false" />
                <asp:GridBoundColumn HeaderText="Danh mục (Tiếng Anh)" SortExpression="ProductDownloadCategoryNameEn"
                    DataField="ProductDownloadCategoryNameEn" Visible="false" />
                    ...
                    <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                        ...
                        <table class="search">
                            ...
                            <tr class="invisible">
                                ...
                                <td>
                                    <asp:RadComboBox Filter="Contains" ID="ddlCategory" runat="server" DataSourceID="ObjectDataSource3"
                                        DataTextField="ProductDownloadCategoryName" DataValueField="ProductDownloadCategoryID"
                                        Width="504px" OnDataBound="DropDownList_DataBound" EmptyMessage="- Chọn -">
                                    </asp:RadComboBox>
                                </td>
                            </tr>
                            <tr>
