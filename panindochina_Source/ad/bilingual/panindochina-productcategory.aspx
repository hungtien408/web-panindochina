<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="panindochina-productcategory.aspx.cs" Inherits="ad_single_productcategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                    ...
                    <asp:GridTemplateColumn HeaderText="Ảnh Hover">
                        <ItemTemplate>
                            ...
                            <img alt="Xóa ảnh" title="Xóa ảnh" src="../assets/images/delete-icon.png" />
                                ...
                                <asp:HiddenField ID="hdnImageNameHover" runat="server" Value='<%# Eval("ImageNameHover") %>' />
                            </asp:Panel>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                </Columns>
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 239px x 167px)</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left" valign="top">
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hdnImageNameHover" runat="server" Value='<%# Eval("ImageNameHover") %>' />
                                        <asp:RadUpload ID="FileImageNameHover" runat="server" AllowedFileExtensions=".jpg,.jpeg,.gif,.png"
                                            ControlObjectsVisibility="None" Culture="vi-VN" InputSize="69" Language="vi-VN" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProductCategoryDelete"
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="ImageNameHover" Type="String" />
