...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
                        ...
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            ...
                            <table runat="server" class="search" visible="<%# (Container is GridEditFormInsertItem) ? true : false %>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtEmailConfirm" runat="server" Width="500px"></asp:TextBox>
                                        <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Xác nhận Email sai."
                                            ControlToCompare="txtEmail" ControlToValidate="txtEmailConfirm" Display="Dynamic"></asp:CompareValidator>
                                        <asp:CustomValidator ID="CustomValidator4" ValidationGroup="AddNewUser" runat="server"
                                            ControlToValidate="txtEmailConfirm" Display="Dynamic"></asp:CustomValidator>
                                        <asp:RegularExpressionValidator ValidationGroup="AddNewUser" ID="RegularExpressionValidator2"
                                            runat="server" ControlToValidate="txtEmailConfirm" Display="Dynamic" ErrorMessage="Sai định dạng email."
                                            ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table class="search">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCompanyName" runat="server" Text='<%# Bind("Company") %>' Width="500px"></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadComboBox Filter="Contains" ID="ddlProvince" runat="server" DataSourceID="ObjectDataSource4"
                                            DataTextField="ProvinceName" DataValueField="ProvinceID" Width="504px" OnDataBound="DropDownList_DataBound"
                                            AutoPostBack="True">
                                        </asp:RadComboBox>
                                    </td>
                                </tr>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            ...
            <asp:TextBoxSetting EmptyMessage="Email Confirm ..." Validation-IsRequired="True">
                <TargetControls>
                    <asp:TargetInput ControlID="txtEmailConfirm" />
                </TargetControls>
            </asp:TextBoxSetting>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="UserProfileSelectAll_AddressBook"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchEmail" Name="Email" PropertyName="Text"
                Type="String" />
            <asp:Parameter DefaultValue="user" Name="RoleName" Type="String" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource4" runat="server" SelectMethod="ProvinceSelectAll"
