<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="panindochina-service.aspx.cs" Inherits="ad_single_service" %>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" AllowPaging="True" 
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn HeaderText="ID" DataField="ServiceID" SortExpression="ServiceID" Visible="false">
                    </asp:GridBoundColumn>
                    ...
                    <asp:GridTemplateColumn DataField="ImageName" HeaderText="Ảnh" SortExpression="ImageName">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ImageName").ToString()) ? false : true %>'>
                                <img alt="" src='<%# "~/res/service/" + Eval("ImageName") %>' width="80" runat="server"
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td runat="server">
                                        ...
                                        <span class="required">(Kích thước 281px x 216px)</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left" colspan="2">
                                        ...
                                        &nbsp;&nbsp;
                                        <asp:CheckBox ID="chkIsNew" runat="server" CssClass="checkbox" Text=" New" Checked='<%# (Container is GridEditFormInsertItem) ? false : (string.IsNullOrEmpty(Eval("IsNew").ToString()) ? false : Eval("IsNew"))%>' Visible="false"/>
                                        &nbsp;&nbsp;
