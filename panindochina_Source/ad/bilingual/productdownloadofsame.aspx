<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/inside.master" AutoEventWireup="true"
    CodeFile="productdownloadofsame.aspx.cs" Inherits="ad_single_productdownloadofsame" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadGrid ID="RadGrid1" DataSourceID="ObjectDataSource1" runat="server" PageSize="20"
        ...
        <MasterTableView Width="100%" CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
            ...
            DataKeyNames="ProductDownloadOfSameID">
            <PagerTemplate>
            ...
            <GroupByExpressions>
                ...
                <asp:GridGroupByExpression>
                    <SelectFields>
                        <asp:GridGroupByField HeaderText="File Download " FieldName="ParentName"></asp:GridGroupByField>
                    </SelectFields>
                    <GroupByFields>
            ...
            <Columns>
                ...
                <asp:GridBoundColumn HeaderText="ID" DataField="ProductDownloadID" HeaderStyle-Width="2%"
                    SortExpression="ProductDownloadID">
                </asp:GridBoundColumn>
                    ...
                    <asp:Panel ID="Panel1" runat="server">
                        <div class="sub_box">
                            ...
                            <asp:RadGrid ID="RadGrid2" AutoGenerateColumns="False" DataSourceID="ObjectDataSource2"
                                ...
                                <MasterTableView PageSize="20" DataKeyNames="ProductDownloadID" AllowFilteringByColumn="True">
                                    <Columns>
                                        <asp:GridClientSelectColumn FooterText="CheckBoxSelect footer" HeaderStyle-Width="2%"
                                            UniqueName="ClientSelectColumn" />
                                        <asp:GridBoundColumn FilterControlWidth="50px" HeaderText="ID" AllowFiltering="False"
                                            DataField="ProductDownloadID" SortExpression="ProductDownloadID">
                                        </asp:GridBoundColumn>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductDownloadOfSameSelectAll"
        TypeName="TLLib.ProductDownloadOfSame" UpdateMethod="ProductDownloadOfSameUpdate"
        InsertMethod="ProductDownloadOfSameInsert" DeleteMethod="ProductDownloadOfSameDelete">
        <DeleteParameters>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource4" runat="server" SelectMethod="ProductDownloadCategorySelectAll"
