...
public partial class ad_single_productcategory : System.Web.UI.Page
{
    ...
    void DeleteImageHover(string strImageNameHover)
    {
        ...
        {
            string strOldImagePathHover = Server.MapPath("~/res/productcategory/imagehover/" + strImageNameHover);
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "DeleteSelected")
        {
            ...
            foreach (GridDataItem item in RadGrid1.SelectedItems)
            {
                ...
                else
                {
                    ...
                    if (!string.IsNullOrEmpty(strImageNameHover))
                    {
                        string strSavePathHover = Server.MapPath("~/res/productcategory/imagehover/" + strImageNameHover);
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            if (e.CommandName == "PerformInsert")
            {
                ...
                string strFullPathHover = "~/res/productcategory/imagehover/" + strImageNameHover;
            ...
            else
            {
                ...
                var strOldImagePathHover = Server.MapPath("~/res/productcategory/imagehover/" + strOldImageNameHover);
