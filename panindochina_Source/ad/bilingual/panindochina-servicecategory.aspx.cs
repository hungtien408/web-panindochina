...
public partial class ad_single_servicecategory : System.Web.UI.Page
{
    ...
    void DeleteImageHover(string strImageNameHover)
    {
        if (!string.IsNullOrEmpty(strImageNameHover))
        {
            string strOldImagePathHover = Server.MapPath("~/res/servicecategory/imagehover/" + strImageNameHover);
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "DeleteSelected")
        {
            ...
            foreach (GridDataItem item in RadGrid1.SelectedItems)
            {
                ...
                else
                {
                    ...
                    string strImageNameHover = ((HiddenField)item.FindControl("hdnImageNameHover")).Value;

                    if (!string.IsNullOrEmpty(strImageNameHover))
                    {
                        string strSavePathHover = Server.MapPath("~/res/servicecategory/imagehover/" + strImageNameHover);
                        if (File.Exists(strSavePathHover))
                            File.Delete(strSavePathHover);
                    }
                }
            }
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            var FileImageNameHover = (RadUpload)row.FindControl("FileImageNameHover");
            ...
            string strImageNameHover = FileImageNameHover.UploadedFiles.Count > 0 ? FileImageNameHover.UploadedFiles[0].GetName() : "";
            ...
            if (e.CommandName == "PerformInsert")
            {
                ...
                string strFullPathHover = "~/res/servicecategory/imagehover/" + strImageNameHover;
            ...
            else
            {
                ...
                var strOldImageNameHover = ((HiddenField)row.FindControl("hdnImageNameHover")).Value;
                var strOldImagePathHover = Server.MapPath("~/res/servicecategory/imagehover/" + strOldImageNameHover);
                ...
                dsUpdateParam["ImageNameHover"].DefaultValue = strImageNameHover;
                ...
                if (!string.IsNullOrEmpty(strImageNameHover))
                {
                    var strFullPathHover = "~/res/servicecategory/imagehover/" + strConvertedServiceCategoryName + "-" + strServiceCategoryID + strImageNameHover.Substring(strImageNameHover.LastIndexOf('.'));
        ...
        if (e.CommandName == "DeleteImageHover")
        {
            var oServiceCategory = new ServiceCategory();
            var lnkDeleteImageHover = (LinkButton)e.CommandSource;
            var s = lnkDeleteImageHover.Attributes["rel"].ToString().Split('#');
            var strServiceCategoryID = s[0];
