<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="panindochina-companydescribes.aspx.cs" Inherits="ad_single_article" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                            ...
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td runat="server">
                                        ...
                                        <span class="required">(Kích thước 255px x 166px)</span>
                                    </td>
                                </tr>
                                <tr>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ArticleSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchDescription" Name="Description" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="ddlSearchCategory" DefaultValue="19" Name="ArticleCategoryID" PropertyName="SelectedValue"
                Type="String" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="ArticleCategorySelectAll"
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="19" Name="parentID" Type="Int32" />
