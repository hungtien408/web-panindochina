    ...
    public class DownloadCategory
    {
        ...
        public DataTable DownloadCategorySelectAll()
        {
            try
            {
                ...
                oCommon.RecursiveFillTree(dt, 0, "ParentID", "DownloadCategoryName", "DownloadCategoryID", "-");
            ...
            string IsShowOnHomePage)
        {
            try
            {
                ...
                //oCommon.RecursiveFillTree(dt, parentID, "ParentID", "DownloadCategoryName", "DownloadCategoryID", increaseLevelCount, IsShowOnMenu, IsShowOnHomePage);
                oCommon.RecursiveFillTree2(dt, parentID, "ParentID", "DownloadCategoryName", "DownloadCategoryID", increaseLevelCount, IsShowOnMenu, IsShowOnHomePage, "-");
        ...
        public DataTable DownloadCategoryForEditSelectAll(
            string DownloadCategoryID
        )
        {
            try
            {
                var dt = new DataTable();
                var scon = new SqlConnection(connectionString);
                var cmd = new SqlCommand("usp_DownloadCategoryForEdit_SelectAll", scon);
                cmd.Parameters.AddWithValue("@DownloadCategoryID", string.IsNullOrEmpty(DownloadCategoryID) ? dbNULL : (object)DownloadCategoryID);
                cmd.CommandType = CommandType.StoredProcedure;
                SqlParameter errorCodeParam = new SqlParameter("@ErrorCode", null);
                errorCodeParam.Size = 4;
                ...
                if (errorCodeParam.Value.ToString() != "0")
                    throw new Exception("Stored Procedure 'usp_DownloadCategoryForEdit_SelectAll' reported the ErrorCode : " + errorCodeParam.Value.ToString());
