    ...
    public class Download
    {
        ...
        )
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Question", string.IsNullOrEmpty(Question) ? dbNULL : (object)Question);
                cmd.Parameters.AddWithValue("@Answer", string.IsNullOrEmpty(Answer) ? dbNULL : (object)Answer);
                cmd.Parameters.AddWithValue("@QuestionEn", string.IsNullOrEmpty(QuestionEn) ? dbNULL : (object)QuestionEn);
